...
education:
  - area: Máster en Data Science & Big Data
    institution: U-TAD
    icon: ""
    ...
    summary: |
      ...
      - **Trabajo Fin de Máster**
        - {{<icon name="hero/link" fa-name="Link">}} [Sistema de detección automática de baches en el asfalto a partir de imágenes](/uploads/sistema-de-deteccion-automatica-de-baches-en-el-asfalto-a-partir-de-imagenes.pdf)
  - area: Ingeniería en Informática
    institution: Universidad de Deusto
    icon: ""
    date_start: 2005-09-01
    date_end: 2007-07-01
  - area: Ingeniería Técnica en Informática de Gestión
    institution: Universidad de Deusto
    icon: ""
...
work:
  ...
  - position: "Software Engineer/Responsable Técnico [ES|FR]"
    ...
    summary: |
      ...
      - **Implantación de un Identity Server:** configuración y despliegue de *WSO2 Identity Server* como núcleo de autenticación para toda la infraestructura de microservicios.
        - {{<icon name="hero/wrench-screwdriver" fa-name="Wrench">}} WSO2 Identiy Server, Docker, Rancher
      - **Desarrollo de un chatbot corporativo:** creación de un chatbot para Skype y SMS basado en *Microsoft Bot Framework* y *Dialogflow*, ofreciendo un nuevo canal de soporte a usuarios.
        - {{<icon name="hero/wrench-screwdriver" fa-name="Wrench">}} Microsoft Bot Framework, Node.js, Restify, IA, NLP, DialogFlow, Azure Bot Service, Twilio, SMS, API REST, Spring Boot, Spring MVC, Spring State Machine, Redis, Docker, Docker Compose
      ...
      - **Aplicación web de gestión de acceso:** desarrollo de un backend *Spring Boot* con *WebSockets* y API REST para el seguimiento en tiempo real de accesos a instalaciones.
        - {{<icon name="hero/wrench-screwdriver" fa-name="Wrench">}} Spring Boot, Apache Camel, XML/RPC, API REST
  ...
  - position: "Analista-Programador [FR]"
    ...
    summary: |
      ...
      {{<icon name="hero/map-pin" fa-name="MapPin">}} Nantes, Francia
  - position: "Referente Técnico [FR]"
    company_name: Banque de France (a través de SopraSteria)
    ...
    summary: |
      ...
      {{<icon name="hero/map-pin" fa-name="MapPin">}} Lille, Francia
  - position: "Responsable Técnico/Líder Técnico de Proyecto [FR|ES]"
    company_name: EDF (a través de SopraSteria)
    ...
    summary: |
      ...
      {{<icon name="hero/map-pin" fa-name="MapPin">}} Madrid, España
  - position: "Referente Técnico [FR|ES]"
    company_name: EDF (a través de SopraSteria)
    company_url: "https://www.edf.fr"
    icon: ""
    ...
    summary: |
      ...
      {{<icon name="hero/map-pin" fa-name="MapPin">}} Madrid, España
  - position: "Programador Fullstack [ES]"
    ...
    summary: |
      ...
      {{<icon name="hero/wrench-screwdriver" fa-name="Wrench">}} Java 6, Spring MVC, REST, Integración con Paypal, Spring Social, Spring Security, Spring Batch, Apache Camel, JSP, HTML, JQuery, AngularJS, Elasticsearch, Spring Data, JPA, Hibernate, MySQL, JUnit, Tomcat, Git

      {{<icon name="hero/map-pin" fa-name="MapPin">}} Madrid, España
  - position: "Analista-Programador [ES]"
    company_name: Gobierno Vasco (a través de Bilbomática)
    company_url: ""
    icon: ""
    ...
    summary: |
      ...
      {{<icon name="hero/map-pin" fa-name="MapPin">}} Bilbao, España
  - position: "Programador [ES]"
    company_name: Gobierno Vasco (a través de Bilbomática)
    company_url: ""
    icon: ""
...
awards:
  - title: 3er puesto en el Hackaton de la 'Geek Week' de The Workshop
    date: "2025-10-01"
